...
|主事件流|
|参与者动作|系统行为|
|1.输入账号<br><br>3.参与者根据需求对个人信息进行修改|<br>2.判断账户正确性<br><br>4.系统根据用户操作后保存更新信息|
|备选事件流|
...
|主事件流|
|参与者动作|系统行为|
|1.输入账号<br>3.输入借出账号<br>8.查看结果|<br>2.判断账号正确性<br>4.判断账号是否正确<br>5.判断图书库存<br>6.借出图书<br>7.修改库存<br>|
|备选事件流|
...
|主事件流|
|参与者动作|系统行为|
|1.输入账号<br>3.输入归还账号<br>9.查看结果|2.判断账号正确性<br>4.判断账号是否正确<br>5.判断用户是否借入图书<br>6.检查书籍是否完整<br>7.归还图书<br>8.修改库存<br>|
|备选事件流|
...
|主事件流|
|参与者动作|系统行为|
|1.输入账号<br><br><br>4.预定成功<br>|<br>2.判断账号正确性<br>3.系统确认该书目库存是否大于等于1|
|备选事件流|
|1a.账号不合法<br><ul>1.系统提示账号错误，用例结束</ul>2a.库存不足<ul>2.系统提示库存不足，用例结束</ul>|
|业务规则|
...
|主事件流|
|参与者动作|系统行为|
|1.参与者输入账号<br><br>3.取消预定操作<br><br>5.取消预订成功|<br>2.判断账号正确性<br><br>4.系统修改库存<br>|
|备选事件流|
...
|主事件流|
|参与者动作|系统行为|
|1.输入账号<br><br>3.进行查询<br><br>|<br>2.判断账号正确性<br><br>4.返回查询信息|
|备选事件流|
|1a.账号不正确<br><ul>1.系统提示账号错误，用例结束</ul>|
|业务规则|
...
|主事件流|
|参与者动作|系统行为|
|1.输入账号<br>3.进行维护<br>5.查看结果|2.判断账号正确性<br>4.结果|
|备选事件流|
|1a.账号不合法<br><ul>1.系统提示账号错误，用例结束</ul>|
|业务规则|
